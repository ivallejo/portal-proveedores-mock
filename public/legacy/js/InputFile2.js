...
function Init_Multiple_Upload2() {
    ...
    $('#FormMultipleUpload button[id=DownloadFormat_btn]').click(function () {
        DescargarDocumentoAprobacion()
    });
}


function DescargarDocumentoAprobacion() {
    var ParamUrl = $("#IdDescargar").val();
    var data = {};


    ajax_download(ParamUrl, data);
...
function UploadMultipleFiles(plantilla) {
    ...
    if (selectedFiles.length > 0) {        
        ...
        dataString.append("plantilla", plantilla);
...
function UploadMultipleFiles2() {
    ...
    var modalidad = $("#Seleccionar_ddlModalidad").val();
    var periodo = $("#Seleccionar_ddlPeriodo").val();
    var tipo = $("#Seleccionar_ddlTipoPermiso").val();
    //var files = document.getElementById("UploadedFiles").files;
    ...
    if (selectedFiles.length > 0) {
        ...
        dataString.append("modalidad", modalidad);
        dataString.append("periodo", periodo);
