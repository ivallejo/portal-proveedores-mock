$(document).ready(function () {
    ...
    btnExportar.on("click", (e) => {
        ...
        anchor.href = URL_BASE + "WkTarifaDocenteConceptoExtraordinario/DescargarExcelRepoGeneral?organizacion=" + $(selectorOrganizacion).val() + "&idPeriodoAcademico=" + $(selectorPeriodo).val() + "&estadoSolicitud=" + $(selectorEstado).val() + "&soloFinales=" + $(checkFinal).is(":checked");
    ...
    btnBuscar.on("click", (e) => {
        ...
        new TarifaDocenteConceptoExtraordinarioService().listarReporteGeneral(request, (response) => {
    ...
    function abrirModalRegistro(item) {
        ...
        if (tarifaDocenteModal)
            ...
            new UtilService().obtenerHtml("WkTarifaDocenteConceptoExtraordinario/_GetView", (html) => {
                divContent.after(html);
                tarifaDocenteModal = new TarifaDocenteConceptoExtraordinarioDetalleRepo();
