$(document).ready(function () {
    ...
    $btnFormato.attr("href", URL_BASE + "WkSolicitud/DescargaFormato?key=" + Constantes.Workflow.TarifaDocentes);
    ...
    btnAgregar.on("click", (e) => {
        ...
        if (text === "Agregar") {
            ...
            new TarifaDocenteService().listarPeriodoAnterior(request, (response) => {
                if (response.lista.length > 0) {
                    wkTarifaDocenteAnt();
    ...
    btnGuardar.on("click", () => {
        ...
        new TarifaDocenteService().agregar(tarifaDocente, (response) => {
    ...
    function abrirModalRegistro(item) {
        if (tarifaDocenteModal)
            ...
            new UtilService().obtenerHtml("WkTarifaDocente/_Create", (html) => {
                ...
                tarifaDocenteModal = new TarifaDocenteCreate();
